...
export const DrawToolbar: React.FC<DrawToolbarProps> = ({
    ...
    return (
        <div className="fixed left-2 md:left-4 top-1/2 -translate-y-1/2 z-[4000] flex flex-col items-center gap-2 md:gap-3 p-2 md:p-4 bg-white/90 backdrop-blur-xl rounded-[24px] md:rounded-[40px] shadow-2xl border-2 md:border-4 border-slate-900 max-h-[90vh] overflow-y-auto no-scrollbar">
            <button
