...
const HIRAGANA_CHARS = [
  ...
  ['ら', 'り', 'る', 'れ', 'ろ'], // 9
  ['わ', 'を', 'ん'], // 10
  ['が', 'ぎ', 'ぐ', 'げ', 'ご', 'ざ', 'じ', 'ず', 'ぜ', 'ぞ'], // 11
  ['だ', 'ぢ', 'づ', 'で', 'ど', 'ば', 'び', 'ぶ', 'べ', 'ぼ'], // 12
  ['ぱ', 'ぴ', 'ぷ', 'ぺ', 'ぽ'], // 13
  ['きゃ', 'きゅ', 'きょ', 'しゃ', 'しゅ', 'しょ'], // 14
  ['ちゃ', 'ちゅ', 'ちょ', 'にゃ', 'にゅ', 'にょ'], // 15
  ['ひゃ', 'ひゅ', 'ひょ', 'みゃ', 'みゅ', 'みょ'], // 16
  ['りゃ', 'りゅ', 'りょ', 'ぎゃ', 'ぎゅ', 'ぎょ', 'じゃ', 'じゅ', 'じょ'], // 17
  ['びゃ', 'びゅ', 'びょ', 'ぴゃ', 'ぴゅ', 'ぴょ'] // 18
];
