...
export const POST: APIRoute = async ({ request }) => {
    try {
        ...
        const focusInstruction =
            focus === 'Tradução Fiel'
                ? 'As 4 opções em português devem ser TRADUÇÕES COMPLETAS e fiéis da frase. Teste precisão léxica e gramatical.'
                : 'As 4 opções devem focar na ESSÊNCIA ou INTENÇÃO da fala. Teste se o aluno entendeu o contexto comunicativo.';
